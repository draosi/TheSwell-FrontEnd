...
export const register = abc => {
    return ( 
        axios.post('https://the-swell-back-end-5ynk.vercel.app/auth/register', {
...
// Check if the user exist in the database and if so, send back its token
export const login = user => {
    return axios.post('https://the-swell-back-end-5ynk.vercel.app/auth/login', {
        email : user.email,
