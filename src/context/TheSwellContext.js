...
export const TheSwellController = ({ children }) => {
  ...
  const fetchUsersData = async () => {
    try {
      const callData = await axios.get(`https://the-swell-back.fly.dev/api/users`);
  ...
  const fetchSpotsData = async () => {
    try {
      const callData = await axios.get(`https://the-swell-back.fly.dev/api/spots`);
  ...
  const fetchCommentsData = async () => {
    try {
      const callData = await axios.get("https://the-swell-back.fly.dev/api/comments");
  ...
  const fetchSurveysData = async () => {
    try {
      const callData = await axios.get("https://the-swell-back.fly.dev/api/surveys");
